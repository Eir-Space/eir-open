    ...
    <main className="pageWrap">
      <section className="hero">
        ...
        <div className="heroInner">
          <div className="heroCopy">
            ...
            <p className="lede">
              A hybrid registry for agent-compatible healthcare skills: public submissions, trust
              badges, moderation tiers, and `health.md` interoperability.
            </p>
            <div className="heroActions">
              ...
              <a
                ...
                href="https://agentskill.sh/submit"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <form className="filterBar" action="/">
          <div className="field">
            ...
            <input
              ...
              name="q"
              defaultValue={q}
              placeholder="pregnancy, diabetes, triage, health.md"
            />
          </div>
          <div className="field">
      ...
      <section className="howItWorks">
        <div className="panel">
          ...
          <p>
            `skills.eir.space` is health-focused. Skills can declare review status, source URLs,
            `health.md` compatibility, linked file patterns like `pregnancy.md`, and moderation tier
            badges.
          </p>
        </div>
        <div className="panel">
          ...
          <p>
            It indexes skills from GitHub repos and `SKILL.md` files, accepts submissions via a web
            form, and ranks discoverability partly from install telemetry. This app mirrors that
            repo-based submission model but adds healthcare trust metadata and moderation tiers.
          </p>
        </div>
      </section>
    </main>
