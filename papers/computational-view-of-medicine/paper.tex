...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[anchor=north west, font=\fontsize{10.5}{13}\selectfont, text=eirslate] at (1.08,1.78)
    {Where more inference};
  \node[anchor=north west, font=\fontsize{10.5}{13}\selectfont, text=eirslate] at (1.08,1.43)
    {can improve the next};
  \node[anchor=north west, font=\fontsize{10.5}{13}\selectfont, text=eirslate] at (1.08,1.08)
    {decision.};
