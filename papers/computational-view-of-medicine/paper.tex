...
\end{tikzpicture}
\caption{Reasoning-focused AI systems already perform strongly on several difficult diagnostic and medical benchmarks. Data from Kanjee et al.\ \citep{kanjee2023}, Singhal et al.\ \citep{singhal2025}, and Mo\"ell et al.\ \citep{moell2025reasoning}. These studies are not identical tasks, but together they show that added computation can improve the quality of clinical synthesis in demanding settings.}
