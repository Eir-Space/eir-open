...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[anchor=west, text width=4.2cm, font=\bfseries\large, text=eirink] at (0.7,4.8)
    {From diagnosis as label\\to diagnosis as search};
  \node[anchor=west, text width=4.6cm, font=\normalsize, text=eirslate] at (0.7,3.55)
    {The central question becomes: where does more inference genuinely improve the next decision?};

  \begin{scope}[shift={(7.5,2.95)}]
    \draw[eirslate!45, line width=0.8pt] (-0.3,-1.7) -- (-0.3,1.75);
    \draw[eirslate!45, line width=0.8pt] (-1.9,-0.1) -- (2.15,-0.1);
    \node[font=\scriptsize\bfseries, text=eirslate] at (0.95,-0.45) {Actionability};
    \node[font=\scriptsize\bfseries, text=eirslate, rotate=90] at (-0.7,0.95) {Computational burden};
    \fill[eirgold] (1.35,1.2) circle (0.18);
    \node[anchor=west, font=\scriptsize, text=eirink] at (1.62,1.2) {Precision oncology};
    \fill[eirblue] (1.05,0.95) circle (0.18);
    \node[anchor=west, font=\scriptsize, text=eirink] at (1.32,0.95) {Rare disease genomics};
    \fill[eirrose] (0.75,0.45) circle (0.18);
    \node[anchor=west, font=\scriptsize, text=eirink] at (1.02,0.45) {Resistant infection};
    \fill[eirblue!70] (0.55,0.15) circle (0.18);
    \node[anchor=west, font=\scriptsize, text=eirink] at (0.82,0.15) {Sepsis / ICU};
    \fill[eirslate] (-0.2,-0.75) circle (0.18);
    \node[anchor=west, font=\scriptsize, text=eirink] at (0.07,-0.75) {Routine protocol care};
  \end{scope}
\end{tikzpicture}
