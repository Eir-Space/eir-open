...
If the computational view is correct, it should change how health AI is evaluated. Average discrimination metrics are not enough. In many of the domains highlighted here, the relevant question is whether reasoning quality improved at the point where the case could still change direction.
