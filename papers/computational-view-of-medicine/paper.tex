...
\hypersetup{
  ...
  pdfauthor={Birger Moëll, Erica Hughberg, Maria Undén Morein, and Sanian Akbar}
}
...
\rhead{\textcolor{eirslate}{Moëll et al.}}
...
\vspace{0.9cm}
{\large Birger Mo\"ell, Erica Hughberg, Maria Und\'en Morein, and Sanian Akbar\\Eir Space\par}
\vspace{0.35cm}
...
\end{tikzpicture}
\caption{Reasoning-focused AI systems already perform strongly on several difficult diagnostic and medical benchmarks. Data from the cited studies \citep{kanjee2023,singhal2025,moell2025reasoning}. These studies are not identical tasks, but together they show that added computation can improve the quality of clinical synthesis in demanding settings.}
