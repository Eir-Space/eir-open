...
- **macOS**: [Download Eir Viewer DMG](https://github.com/eir-space/eir-open-apps/releases/latest)
...
- [CBT Programs Registry](/eir-open/docs/cbt-programs/) — modular, multilingual, provenance-aware CBT programs
...
- [EIR Provider Directory](/eir-open/docs/eir-provider-directory/) — Sweden-wide care finder with verified service capabilities
